...
const Home = () => {
    ...
    const cryptocurrencies = useGetCryptosQuery(8)
    const globalStats = cryptocurrencies.data?.data?.stats
        ...
        <>
            {
                ...
                <>
                    ...
                    <div className="home-heading-container">
                        <Title level={2} className="home-title">Top Crypto Coins</Title>
